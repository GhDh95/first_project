...
<div class="flex flex-col items-center p-20 space-y-14">
    ...
    <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" class=" grid grid-cols-1 gap-y-2 md:grid md:grid-cols-5 md:justify-items-center md:items-center bg-slate-50 md:py-20 py-20 px-2">
